    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                "custom-colors-neonaccent": "#00d4ff",
                "destructive-foreground": "#FFFFFF",
                "custom-colors-foreground": "#FFFFFF",
                "neon-accent": "#00d4ff",
                "custom-colors-destructiveforeground": "#FFFFFF",
                "custom-colors-destructive": "#DF3131",
                subtleborder: "#FFFFFF",
                "primary-foreground-new": "#000000",
